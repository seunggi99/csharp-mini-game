        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        mysql.Open();
                        string insertQuery = string.Format("INSERT INTO ksg (name, pw, nickname, `baseball`, `baseball_success`, `baseball_fail`, `car`, `mousecontrol`, `block`) VALUES ('{0}', '{1}', '{2}',0,0,0,0,99999999,0);",
